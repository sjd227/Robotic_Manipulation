...
def handle_move_robot(req):
	...
	if (req.Action == 0):
		...
		if (req.Action == 2):
			...
			if (req.Target != msg.block_in_gripper) and ((req.Target ==0) or (msg.gripper_state == 0 and ((req.Target+1) not in msg.block_under)) or (msg.gripper_state == 1 and (req.Target not in msg.block_under))):
